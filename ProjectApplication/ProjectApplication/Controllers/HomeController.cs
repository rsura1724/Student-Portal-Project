...
namespace ProjectApplication.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,FirstName,LastName,PhoneNumber,EmailAddress,CourseID,DepartmentID")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,FirstName,LastName,PhoneNumber,EmailAddress,CourseID,DepartmentID")] Student student)
        {
            if (ModelState.IsValid)
            {
